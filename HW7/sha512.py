...
class SHA512(object):
    ...
    def sha512(self):
        # The registers are initialized by the first 64 bits of the fractional parts of
        # the square-roots of the first eight primes
        # The hash buffer consists of 8 64-bit words named h0, h1, h2, h3, h4, h5, h6, and h7.
        ...
        #  These are as provided on page 43-46 of the Lecture 15 created by Professor Kak.
